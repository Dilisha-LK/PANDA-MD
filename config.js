...
module.exports = {
  ...
  // ADD Your Session Id 
  MONGODB: process.env.MONGODB || " put your mongodb url ",
  ...
  packname: process.env.packname || "DILISHA TECH",
  author: process.env.author || "DILISHA",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_PANDA-MD Connected Successfully!_* ✅ 

--- *👨‍💻🎉 _Welcome to PANDA-MD!_* 🎉💗 

*🔹 OWNER:* 94775713391

_Thank you for using_ *👨‍💻PANDA-MD💗.*
_We're here to make your experience enjoyable and seamless._
_If you need any help or have questions, don't hesitate to ask._ 🌝💗

*🖇️Join My WhatsApp Channel✓💗 - :* https://whatsapp.com/channel/0029VaoPSh9HrDZdNIpYes0s

*🖇️Subscribe My Youtube Channel✓💗 - :* https://www.youtube.com/@srilanka-no1AWM-FF

*🖇️Fork & Star My Repo✓💗 - :* https://github.com/HerokuZR/PANDA-MD

*🖇️Follow My Github Account✓💗 - :* https://github.com/HerokuZR

_*👨‍💻 Enjoy your time with us! 😊*_

> *© 𝑃𝑂𝑊𝐸𝐷 𝐵𝑌 𝑃𝐴𝑁𝐷𝐴-𝑀𝐷 *` ,

  ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/GnrGf3T/tj9-Thmm-T6628.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://i.ibb.co/GnrGf3T/tj9-Thmm-T6628.jpg",
